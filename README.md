...
- Once the project has been cloned into the directory you can type and enter 1) ```npm install``` to setup dependencies 2) then type and enter ```npm start```.
- Process should be served and make sure your api or json server is still serving and both tabs remain open in terminal while you run the application. Register your own user and be sure to remember the password
